...
- (KObject *)initWithData:(id)aData andLifeDuration:(NSInteger)aDuration
{
    ...
    if (self) {
        ...
        self.data = [NSKeyedArchiver archivedDataWithRootObject:[[NSMutableDictionary alloc] initWithObjectsAndKeys:
                                                     aData, KCH_OBJ_DATA,
                                                     [NSString stringWithFormat:@"%ld", (long)[KUtil expiredTimestampForLife:aDuration]], KCH_OBJ_LIFE,
                                                     nil]];
        return self;
    }
...
- (void)updateLifeDuration:(NSInteger)aDuration
{
    ...
    [self.object setValue:[NSString stringWithFormat:@"%ld", (long)[KUtil expiredTimestampForLife:aDuration]]
                                          forKey:KCH_OBJ_LIFE];
}
