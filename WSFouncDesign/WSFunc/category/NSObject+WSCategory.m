...
+ (NSDictionary *)ws_codableProperties
{
    ...
    {
        WSLog(@"AutoCoding Warning: codableKeys method is no longer supported."
    ...
    if ([self respondsToSelector:deprecatedSelector] ||
        [self instancesRespondToSelector:deprecatedSelector])
    {
        WSLog(@"AutoCoding Warning: uncodableKeys method is no longer supported."
        ...
        [self instancesRespondToSelector:deprecatedSelector])
    {
        ...
        WSLog(@"AutoCoding Warning: uncodableProperties method is no longer supported."
             " Use ivars, or synthesize your properties using non-KVC-compliant names to avoid coding them instead.");
    }
...
- (NSDictionary *)ws_codableProperties
{
    ...
    if (!codableProperties)
    {
        ...
        {
            [(NSMutableDictionary *)codableProperties addEntriesFromDictionary:[subclass ws_codableProperties]];
...
- (NSDictionary *)ws_storableProperties
{
    ...
    if (!storableProperties)
    {
        ...
        while (subclass != [NSObject class])
        {
            [(NSMutableDictionary *)storableProperties addEntriesFromDictionary:[subclass ws_storableProperties]];
            subclass = [subclass superclass];
        }
