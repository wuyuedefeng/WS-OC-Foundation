...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        NSDictionary *properties = [self ws_codableProperties];
...
{
    for (NSString *key in [self ws_codableProperties]) {
...
- (NSDictionary *)ws_dictionaryRepresentation
{
    NSMutableDictionary *dictionary = [NSMutableDictionary dictionary];
    for (__unsafe_unretained NSString *key in [self ws_codableProperties]) {
...
+ (instancetype)ws_objectWithContentsOfFile:(NSString *)filePath
{
    //load the file
...
- (BOOL)ws_writeToFile:(NSString *)filePath atomically:(BOOL)useAuxiliaryFile
{
